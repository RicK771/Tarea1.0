...
U Octave incorpora la versión 6.3.0 y es la opción más recomendable. Descarga octave-6.3.0-w32-installer.exe (319 Mb) u octave-6.3.0-w64-installer.exe (325 Mb), según tengas un Windows de 32 o 64 bits (si no sabes qué versión tienes, escoge la de 32), y ejecuta el archivo para instalar el programa
